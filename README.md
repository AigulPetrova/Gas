...
**ВНИМАНИЕ: применить единую общую нейросеть, полученную в задаче 1**


**Папка 3. Работающий скрипт по одному уровню параметров: detection_3_param_1_level_vertical_lines_on_graf_anomaly_3.m**


**ВНИМАНИЕ: применена старая нейросеть, обученная на 4 ГРС, соответственно, data другие чем в п.1.**
